...
437 tests across two Vitest projects, plus three Playwright suites (42 browser tests including the sign-in setup) — every one of them gating each push and pull request:
